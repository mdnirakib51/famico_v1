...
class ColorRes {
  ...
  static const Color greyBlue = Color(0xFF607D8B);
  ...
  static const Color textPrimary = Color(0xFF1A1A1A);   // Dark text for primary content
  static const Color textSecondary = Color(0xFF666666); // Medium grey for secondary text
  static const Color textTertiary = Color(0xFF999999);  // Light grey for tertiary text
  ...
  static const Color appColor = Color(0xFF8DC73F);
